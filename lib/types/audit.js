...
import { buildDigest, byAuthor, defaultMemoriesRoot, defaultSessionsRoot, parseLog, perDay, scanMemories, scanSessions, } from "./scan.js";
...
export async function runAudit(options) {
    ...
    const gitSection = { isRepo: false, totalCommits: 0, perDay: [], authors: [], recent: [] };
